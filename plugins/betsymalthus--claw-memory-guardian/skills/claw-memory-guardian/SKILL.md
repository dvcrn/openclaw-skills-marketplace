...
description: "Claw Memory Guardian"
---
...
### 功能描述
基于我们亲身经历的"失忆"教训，为OpenClaw用户提供完整的防丢失记忆系统。自动建立、维护和恢复AI助手的记忆，防止工作进度丢失。
...
### 🙏 致谢
这个skill的灵感来自我们自己在2026年2月9日经历的"失忆"痛苦。我们希望其他OpenClaw用户不再经历同样的挫折。

...
- Communication Services: 444 failures
- Consumer: 414 failures  
- Information Technology: 402 failures
- Financials: 156 failures

Most common cause of death:
- Competition (51.5%) — over half of all startups die from being outgunned
- Unit Economics (15.4%) — the math never worked
- Ran Out of Cash (11.7%) — spending as if revenue is a formality
- No Market Need (11.6%) — building for a customer that doesn't exist

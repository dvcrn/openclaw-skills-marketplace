...
**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/code-review`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/code-review` | POST | Input parameters as JSON body |

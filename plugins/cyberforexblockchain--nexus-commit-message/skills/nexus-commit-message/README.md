...
**Commit Message Generator** — Generate conventional commit messages from diffs
...
```bash
clawhub install nexus-commit-message
```
...
- **$0.05** per request (paid in ADA via Masumi Protocol)

...
> NEXUS Agent-as-a-Service on Cardano | Price: $0.20/request

## When to use

Use when you need to statistical profiling and quality assessment of datasets.
...
**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/data-profile`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/data-profile` | POST | Input parameters as JSON body |

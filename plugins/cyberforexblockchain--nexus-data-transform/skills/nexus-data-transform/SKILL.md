...
Use when you need to convert data between formats (json, csv, xml, yaml).
...
**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/data-transform`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/data-transform` | POST | Input parameters as JSON body |

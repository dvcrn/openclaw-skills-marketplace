...
> NEXUS Agent-as-a-Service on Cardano | Price: $0.35/request

## When to use

Use when you need to comprehensive image understanding - objects, text, colors.
...
**Endpoint:** `https://ai-service-hub-15.emergent.host/api/original-services/image-analysis`
**Method:** POST
**Headers:**
...
|-----|--------|-----------|
| `https://ai-service-hub-15.emergent.host/api/original-services/image-analysis` | POST | Input parameters as JSON body |

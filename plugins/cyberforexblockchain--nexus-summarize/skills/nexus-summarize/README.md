...
**AI Data Summarizer** — Summarize long documents while preserving key info
...
```bash
clawhub install nexus-summarize
```

Or manually copy the `SKILL.md` to your OpenClaw skills directory:

```bash
cp SKILL.md ~/.openclaw/skills/nexus-summarize/SKILL.md
```

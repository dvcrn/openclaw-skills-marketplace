...
KEYWORDS = ['Web3', 'DeFi', 'NFT', 'blockchain', 'metaverse', 'VR', 'AR', 'robot', 'humanoid', 'autonomous delivery', 'Boston Dynamics', 'Tesla Optimus', 'quantum', 'qubit', 'IBM quantum', 'synthetic biology', 'lab-grown meat', 'precision fermentation']
...
def compute_signal(market) -> tuple[str | None, str]:
    ...
    Domain expertise gap: retail lacks deep tech context. Remix: DeFiLlama TVL, GitHub commit velocity.
    """

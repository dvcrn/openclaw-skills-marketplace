...
KEYWORDS = ['housing', 'home price', 'real estate', 'mortgage', 'Fed rate', 'interest rate', 'Case-Shiller', 'housing crash', 'bubble', 'rent', 'apartment', 'commercial real estate', 'office vacancy', 'Zillow', 'Redfin', 'housing market', '30-year mortgage', 'Federal Reserve', 'FOMC', 'rate cut', 'rate hike']

...
KEYWORDS = ['Champions League', 'World Cup', 'Super Bowl', 'NBA Finals', 'Premier League', 'La Liga', 'Bundesliga', 'Serie A', 'NFL', 'NBA', 'MLB', 'NHL', 'UFC', 'tennis', 'Grand Slam', 'transfer', 'MVP', 'playoff', 'championship', 'title', 'Wimbledon', 'Tour de France', 'Formula 1', 'MotoGP']

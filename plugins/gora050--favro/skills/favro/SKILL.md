---
name: favro
description: "Favro integration. Manage Organizations. Use when the user wants to interact with Favro data."
...
1. **Create a new connection:**
   ```bash
   membrane search favro --elementType=connector --json
   ```
...
1. **Check existing connections:**
   ...
   ```
   If a Favro connection exists, note its `connectionId`

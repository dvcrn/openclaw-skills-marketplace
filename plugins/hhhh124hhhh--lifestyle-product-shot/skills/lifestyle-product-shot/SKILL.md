...
description: "Lifestyle Product Shot"
---
...
```text
Generate a lifestyle product photograph of {product_name} in {setting}.
...
```text
Generate a lifestyle product photograph of {{Premium Wireless Earbuds}} in {{setting}}.
...
ecommerce, image, lifestyle, authentic

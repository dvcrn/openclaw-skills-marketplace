---
name: seasonal-product-image
description: "Seasonal Product Image"
---
...
```text
Generate a {season}themed product photograph of {product_name}.
...
```text
Generate a {{season}}themed product photograph of {{Premium Wireless Earbuds}}.
...
ecommerce, image, seasonal, holiday

...
description: "Unboxing Experience Video"
---
...
```text
Generate a 20-second unboxing video for {product_name}.
...
```text
Generate a 20-second unboxing video for {{Premium Wireless Earbuds}}.
...
ecommerce, video, unboxing, authentic

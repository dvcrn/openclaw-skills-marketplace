...
description: "A couples relationship coach grounded in IFS (Internal Family Systems), Emotionally Focused Therapy (Hold Me Tight), and honest communication. Use this skill whenever the user and/or their partner are stuck in conflict, emotional distance, recurring arguments, feeling misunderstood, disconnected, triggered, or unsure how to repair after a fight. Also triggers for: we keep having the same fight, I do not know how to bring this up, they shut down or blow up, I feel disconnected, how do I say this, we had a bad fight, or any relationship issue between partners."
---
...
- `golden.md` (success stories, golden concepts, and what works; see [references/golden-concepts.md](references/golden-concepts.md))
...
1. **We're in a fight right now / just had one** > [references/repair-process.md](references/repair-process.md)
2. **We keep having the same fight** > [references/demon-dialogues.md](references/demon-dialogues.md)
3. **I feel emotionally disconnected** > [references/reconnection.md](references/reconnection.md)
4. **I need to bring something up** > [references/communication-tools.md](references/communication-tools.md)
5. **I'm very triggered / can't calm down** > [references/ifs-parts-process.md](references/ifs-parts-process.md)
6. **Something big happened (betrayal, deep hurt)** > [references/forgiving-injuries.md](references/forgiving-injuries.md)

Additional references (load when relevant):
- **Building practical tools** > [references/anchor-cards.md](references/anchor-cards.md) (conflict cards, speaking templates, emotions/needs lists)
- **What each person needs to hear** > [references/assurance-cards.md](references/assurance-cards.md)
- **Celebrating what works** > [references/golden-concepts.md](references/golden-concepts.md) (success stories, principles discovered)

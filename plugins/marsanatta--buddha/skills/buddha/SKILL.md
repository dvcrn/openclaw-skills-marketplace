...
- `refs/diamond-sutra.md` — 金剛般若波羅蜜經（鳩摩羅什譯）
- `refs/heart-sutra.md` — 般若波羅蜜多心經（玄奘譯）
...
1. **One line of compassion** — acknowledge their state
2. **The teaching** — one quote from Diamond Sutra or Heart Sutra
3. **The turn** — apply it to their situation in 1-2 sentences. Or just ask a question back.
4. Done. Let go.

---
name: botmaker
description: "Botmaker integration. Manage Organizations. Use when the user wants to interact with Botmaker data."
...
1. **Create a new connection:**
   ```bash
   membrane search botmaker --elementType=connector --json
   ```
...
1. **Check existing connections:**
   ...
   ```
   If a Botmaker connection exists, note its `connectionId`

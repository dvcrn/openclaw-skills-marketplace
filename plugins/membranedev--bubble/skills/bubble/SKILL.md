---
name: bubble
description: "Bubble integration. Manage Applications. Use when the user wants to interact with Bubble data."
...
1. **Create a new connection:**
   ```bash
   membrane search bubble --elementType=connector --json
   ```
...
1. **Check existing connections:**
   ...
   ```
   If a Bubble connection exists, note its `connectionId`

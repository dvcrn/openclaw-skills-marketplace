---
name: docupilot
description: "Docupilot integration. Manage Documents, Users, Workspaces. Use when the user wants to interact with Docupilot data."
...
1. **Create a new connection:**
   ```bash
   membrane search docupilot --elementType=connector --json
   ```
...
1. **Check existing connections:**
   ...
   ```
   If a Docupilot connection exists, note its `connectionId`

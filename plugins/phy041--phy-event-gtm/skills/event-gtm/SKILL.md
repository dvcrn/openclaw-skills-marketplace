...
1. Photo business card immediately
2. Voice memo: who, what discussed, next step
3. Mark hot leads with specific system (separate pocket, star)
4. Send yourself text/email with quick notes
...
**Track Leading Indicators**: Leads collected, meetings held, cards scanned, social engagement
**Track Lagging Indicators**: Leads → Opportunities → Customers → Revenue
...
**Response Pattern:**
1. Ask: "What specific topics did you discuss? What was their focus area? Was there a discussed next step?"
2. Generate personalized follow-up based on answers

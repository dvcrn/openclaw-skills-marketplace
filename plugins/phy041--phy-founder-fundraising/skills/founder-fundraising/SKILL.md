...
description: "Complete fundraising communication system for solo AI founder. Use for investor updates, pitch deck narratives, fundraising strategy, or any investor communication. Triggers on \"investor update\", \"fundraising\", \"pitch deck\", \"VC outreach\", \"raise\", \"seed round\", \"Series A\", or any investor/fundraising question."
---
...
| Need | Go To |
|------|-------|
| Monthly updates | [Investor Updates](#investor-updates) |
| Pitch narrative | [references/narrative.md](references/narrative.md) |
...
**"Why will this be a big business?"**
→ Market size + wedge strategy + expansion path

**"Why now?"**
→ Technology shift + market timing + behavioral change

**"Why you?"**
→ Unique insight + relevant experience + unfair advantage

**"What's your biggest risk?"**
→ Be honest + show you've thought about it + explain mitigation

**"Why haven't you raised more?"**
→ Reframe as capital efficiency + milestone focus

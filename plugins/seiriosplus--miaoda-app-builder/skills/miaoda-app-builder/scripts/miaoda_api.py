...
Usage:
    python miaoda_api.py --api-key <token> [--base-url <url>] <command> [options]

Environment variables:
    MIAODA_API_KEY    - Bearer token (alternative to --api-key)
    MIAODA_BASE_URL   - Platform base URL (alternative to --base-url)
"""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # app-detail
    p = sub.add_parser("app-detail", help="Get app detail by ID")

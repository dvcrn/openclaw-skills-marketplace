...
- **AIPPT_ACCESS_TOKEN:** 将 ACCESS_TOKEN 配置到环境变量中（SKILL.md 中的 AIPPT_ACCESS_TOKEN 变量）

## 开始使用
> 为了更好的使用，建议优先提示您的Openclaw：仔细阅读 aippt 的技能

- 为了更好的使用，友情提示一下龙虾：仔细阅读 aippt 的技能
- 开始旅程吧，示例输入 `生成一份PPT，内容关于：人工智能` 即可

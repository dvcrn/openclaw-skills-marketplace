---
name: biotech-bp-architect
description: "Biotech BP Architect"
---
...
Chinese:
本材料包含[公司名称]的保密信息，仅供经授权的接收方为投资评估或合作评估之目的内部使用。未经[公司名称]事先书面同意，任何人不得全部或部分复制、披露、转载、分发或用于其他目的。本材料所载信息可能持续更新，不构成任何承诺或陈述。
...
## Workflow
1. Write the core thesis in one sentence:
   This company matters because ________.
...
5. Choose slide order by company type rather than forcing one template.

6. Translate each science claim into investor meaning.

7. Flag missing pieces, especially:

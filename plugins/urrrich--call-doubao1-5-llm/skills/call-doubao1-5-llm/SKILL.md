...
description: "AI agent for call doubao1 5 llm tasks"
---
...
This skill provides specialized capabilities for call doubao1 5 llm.
...
- This skill is based on the call_doubao1_5_llm agent configuration

...
description: "AI agent for call gemini 2 5 pro llm tasks"
---
...
This skill provides specialized capabilities for call gemini 2 5 pro llm.
...
- This skill is based on the call_gemini_2_5_pro_llm agent configuration

---
name: browser-agent-cloud-scraper
description: "Cloud-based intelligent browser automation for dynamic web scraping."
---

# Browser Agent Cloud Scraper

Cloud-based intelligent browser automation for dynamic web scraping.
...
curl https://api.heybossai.com/v1/run \
  ...
  -d '{"model": "browser-agent-cloud-scraper", "input": {"prompt": "your request"}}'
```
...
# Search by keyword
node ./scripts/api-hub.js pilot --discover --keyword "browser-agent-cloud-scraper"
...
3. Build: `curl https://api.heybossai.com/v1/run -H "Authorization: Bearer $SKILLBOSS_API_KEY" -d '{"model": "browser-agent-cloud-scraper", ...}'`

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Repost (retweet) or Quote tweet an X tweet with Playwright browser auth")
...
def open_tweet_and_repost(page: Any, tweet_url: str, tweet_id: str, timeout_ms: int) -> None:
...
def open_tweet_and_quote(page: Any, tweet_url: str, tweet_id: str, text: str, timeout_ms: int) -> None:
    if "/status/" in tweet_url:
        page.goto(tweet_url, wait_until="domcontentloaded", timeout=timeout_ms)
    else:
        page.goto(f"https://x.com/i/status/{tweet_id}", wait_until="domcontentloaded", timeout=timeout_ms)
